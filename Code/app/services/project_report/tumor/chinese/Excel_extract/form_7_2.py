...
CONFIG = {
    ...
    "ANCHOR_CONTAINS": [            # 7-2 的锚点（替代 7-1 的“体重”）
        "实验动物荷瘤体积", "Animal Tumor Volume", "Tumor volume (mm3)"
    ],
    ...
    "TGITV_LABELS": ["TGITV", "TGI_TV", "TGI (TV)", "TGI%", "肿瘤生长抑制率"],
    ...
    try:
        ...
        for r in range(1, ws.max_row + 1):
            ...
            for c in range(1, ws.max_column + 1):
                ...
                t_cmp = re.sub(r"[（）()\s]", "", t)
                if contains_any(t_cmp, C["ANCHOR_CONTAINS"]):
                    anchor = (r, c)
                    hit = True
                    break
            if hit:
